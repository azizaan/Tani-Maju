...
//        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.MESSAGE, "Data Produk"));
//        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PERM_CONTACT_CALENDAR, "Transaksi"));
//        addTitle("MANAGEMENT USER");
//        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.WHATSHOT, "Data User"));
